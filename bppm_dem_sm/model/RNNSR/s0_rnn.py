...
def _train_and_save():
    ...
    # X: FRAMES_IN frames of [x,y,z,r] per particle
    ...
    X = np.concatenate(Xs, axis=0)  # [num_samples, FRAMES_IN, 4]
    ...
    model = tf.keras.Sequential(
        [
            tf.keras.layers.Input(shape=(FRAMES_IN, 4)),
    ...
    model.save(
        r"C:\Users\Fernando\OneDrive - electro controles del noroeste\MCD\trabajo_terminal\s1_model\m0_RNN\rnn_gru_sic_model"
    )
